  ...
  return (
    <section className="rounded-2xl border border-line bg-surface p-5 sm:col-span-2">
      ...
      <p className="mb-4 text-[0.875rem] leading-relaxed text-muted">
        Офлайн-режим работает всегда. Подключите сервис генерации, чтобы получать
        фотореалистичный результат по снимку клиента.
      </p>
      ...
      {draft.provider !== 'none' && (
        <div className="mt-4 flex gap-2.5 rounded-xl border border-clay/20 bg-clay-soft p-3.5">
          ...
          <p className="text-xs leading-relaxed text-graphite">
            Ключ сохраняется только в этом браузере и никуда больше не передаётся, но любой
            запрос из браузера видно в инструментах разработчика. Для рабочего продукта ключ
            должен храниться на сервере, а приложение — обращаться к нему.
          </p>
        </div>
      )}
